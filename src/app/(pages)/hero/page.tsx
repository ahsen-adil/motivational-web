    ...
    <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full md:w-1/2 mb-12 md:mb-0">
          ...
          Transform Your Dreams into Reality – Start Your Rise Today
          </h1>
          <p className="text-xl mb-8 text-gray-300 font-serif font-bold">
          Are you ready to unlock the best version of yourself? 
          </p>
        ...
        <div className="w-full md:w-1/2 md:pl-12">
          <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl">
            <h2 className="text-2xl font-semibold mb-6">What does it take to achieve greatness?</h2>
